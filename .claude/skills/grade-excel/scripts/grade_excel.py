...
def export_workbook_payload(input_path: str | Path, sheet_name: str | None = None) -> dict[str, Any]:
...
def main() -> int:
    ...
    if args.command == "export":
        payload = export_workbook_payload(input_path=args.input, sheet_name=args.sheet)
